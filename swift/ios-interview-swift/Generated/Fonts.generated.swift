...
internal enum FontFamily {
  ...
  internal enum OpenSans {
    ...
    internal static let all: [FontConvertible] = [regular, light]
  }
  internal static let allCustomFonts: [FontConvertible] = [Montserrat.all, OpenSans.all].flatMap { $0 }
...
internal struct FontConvertible: Equatable {
